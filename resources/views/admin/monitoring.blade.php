...
<layouts-main-app>
    ...
    <div class="p-4 sm:ml-64 bg-white dark:bg-gray-900">
        <button data-modal-target="setting_status" data-modal-toggle="setting_status"
            ...
            type="button">
            <svg class="w-5 h-5 mr-2 -ml-1" fill="currentColor" viewBox="0 0 512 512"
            ...
            <div class="flex justify-between items-start w-full">
                <div class="flex-col items-center">
                    <div class="flex items-center mb-1">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Monitoring Pemilihan
                        </h5>                        
                    </div>
                </div>
            </div>
    ...
    <x-modal-settingstatus></x-modal-settingstatus>
