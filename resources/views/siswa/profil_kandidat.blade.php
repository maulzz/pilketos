            ...
            @foreach ($kandidat as $kandidat)
                <div
                    ...
                    <div class="p-5">
                        ...
                        <button data-modal-target="modal-visimisi{{$kandidat->id}}" data-modal-toggle="modal-visimisi{{$kandidat->id}}" type="button"
                ...
                <x-modal_visimisi :kandidat="$kandidat"></x-modal_visimisi>
            @endforeach
        </div>
    </div>
